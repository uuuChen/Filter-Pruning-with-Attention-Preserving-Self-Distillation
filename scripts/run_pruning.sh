...
# AT + KD
python3 pruning.py --t-model resnet56 --s-copy-t --dataset cifar10 --prune-rates 0.6 --prune-mode filter-r --t-path saves/resnet56_cifar10/initial_train/model_epochs_163.pt --distill at --betas 1000 --log-name AT.txt --seed 8152

# SP + KD
python3 pruning.py --t-model resnet56 --s-copy-t --dataset cifar10 --prune-rates 0.6 --prune-mode filter-r --t-path saves/resnet56_cifar10/initial_train/model_epochs_163.pt --distill sp --betas 3000 --log-name SP.txt --seed 8152
...
# AT + KD
python3 pruning.py --t-model resnet56 --s-copy-t --dataset cifar100 --prune-rates 0.6 --prune-mode filter-r --t-path saves/1625594199/model_best.pt --distill at --betas 1000 --log-name AT.txt --seed 8152

# SP + KD
python3 pruning.py --t-model resnet56 --s-copy-t --dataset cifar100 --prune-rates 0.6 --prune-mode filter-r --t-path saves/1625594199/model_best.pt --distill sp --betas 3000 --log-name SP.txt --seed 8152
...
# AT + KD
python3 pruning.py --t-model resnet56 --s-copy-t --t-path saves/1630871975/model_best.pt --dataset cinic10 --prune-rates 0.6 --prune-mode filter-r --distill at --alpha 0.6 --betas 50 --kd-t 16.0 --n-epochs 140 --lr 0.01 --schedule 100 120 --lr-drops 0.1 0.1 --batch-size 96 --log-name pruned-CINIC10.txt --seed 8152

# SP + KD
python3 pruning.py --t-model resnet56 --s-copy-t --t-path saves/1630871975/model_best.pt --dataset cinic10 --prune-rates 0.6 --prune-mode filter-r --distill sp --alpha 0.6 --betas 2000 --kd-t 16.0 --n-epochs 140 --lr 0.01 --schedule 100 120 --lr-drops 0.1 0.1 --batch-size 96 --log-name pruned-CINIC10.txt --seed 8152
...
# AT + KD
python3 pruning.py --t-model resnet50 --s-copy-t --dataset imagenet --n-epochs 100 --batch-size 256 --lr 0.1 --schedule 30 60 90 --lr-drops 0.1 0.1 0.1 --prune-rates 0.6 --prune-mode filter-r --distill at --betas 1000 --seed 8152

# SP + KD
python3 pruning.py --t-model resnet50 --s-copy-t --dataset imagenet --n-epochs 100 --batch-size 256 --lr 0.1 --schedule 30 60 90 --lr-drops 0.1 0.1 0.1 --prune-rates 0.6 --prune-mode filter-r --distill sp --betas 3000 --seed 8152
