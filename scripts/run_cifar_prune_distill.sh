...
# MSP + KD
python3 pmsp.py --t-model resnet56 --dataset cifar10 --prune-rates 0.6  --samp-batches 15 --t-path saves/resnet56_cifar10/initial_train/model_epochs_163.pt --distill msp --seed 8152 --betas 500 --msp-ts 3
